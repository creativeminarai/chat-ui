...
const chatScenarios = {
    ...
    "hard_bread": {
        text: "私たちの誇り、[[『ルヴァン・ナチュレ・カンパーニュ』]]です！[[img:levain_campange.JPG]]ルヴァン種100%の深いコクがたまりません。焼き上がるまでに[[丸3日間]]の熟成が必要で、仕込んでから[[4日目]]にようやく完成する手間暇かかったパンなんです。毎日種を[[『リフレッシュ』]]して新鮮な状態で使う、[[80年守り抜いた酵母]]の魔法が詰まっています！",
        options: [
            { text: "他のパンも見る", next: "bread_top" },
            { text: "最初にもどる", next: "start" }
        ]
