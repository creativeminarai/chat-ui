...
const chatScenarios = {
    ...
    "croissant_detail": {
        ...
        text: [
            ...
            "バターは[[明治発酵バター]]または[[日高バター]]を使用し、職人が丁寧に生地を折り重ねることで、絶妙な[[18層]]に仕上げています。",
            "[[img:croissant_layer.JPG]]この層によって、外は[[サクサク]]、中は[[もっちり]]とした独特の食感と豊かな香りが生まれるんですよ。",
            "ふんわりとした甘みが広がる、まさに自慢の逸品です！"
        ],
        options: [
    ...
    "croissant_taste": {
        speaker: "tenshu_bread",
        text: [
            "外は[[サクサク]]、中は[[もっちり]]。18層が生み出す魔法の食感です！"
        ],
        options: [
