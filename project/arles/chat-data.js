...
const chatScenarios = {
    ...
    "hard_bread": {
        text: "私たちの誇り、[[ルヴァン種のカンパーニュ]]です！[[img:levain_campange.JPG]]100%ルヴァン種で作っているので、その[[酸味と旨味]]を存分に味わうならぜひこちらをどうぞ。ルヴァンの効果で香りもぐんと良くなり、翌日、2日後とさらに香りが増していきます。袋を開けただけで、[[部屋中がパンの旨味の香り]]に包まれるほどなんですよ！",
        options: [
    ...
    "hard_bread_taste": {
        text: "「酸っぱいパンは苦手！」と思っていたお客様も、このカンパーニュはぜひ一度お試しください。パンにおける[[酸味の概念]]が変わりますよ。いわゆる「すっぱい」パンとは違う、[[味わい深い酸味と旨味]]がたっぷりと溶け合っているんです。……その秘密は、実は[[『熟成』]]にあります。",
        options: [
            { text: "熟成の秘密って？", next: "hard_bread_process" },
            { text: "他のパンも見る", next: "bread_top" },
            { text: "最初にもどる", next: "start" }
    ...
    "hard_bread_process": {
        text: "焼き上がるまでに[[丸3日間]]の熟成が必要で、仕込んでから[[4日目]]にようやく完成する手間暇かかったパンなんです。毎日種を[[『リフレッシュ』]]して新鮮な状態で使う、[[80年守り抜いた酵母]]の魔法が詰まっています！",
        options: [
    ...
    "daily_bread": {
        text: "もっちり食感の[[『湯種食パン』]]や、バターをたっぷり包み込んだ[[『塩パン』]]など、毎日の食卓をちょっと贅沢にしてくれる、私たちの自信作です！どちらのお話を聞きたいですか？",
        options: [
    ...
    "sio_pan": {
        text: "こちらの[[塩パン]]は、バターをたっぷり贅沢に包み込んで焼き上げています！[[img:siopan.jpg]]生地には[[湯種]]を使用しているので、外はカリッと、中は驚くほどもっちりとした食感に仕上がっていますよ。",
        options: [
            { text: "他のパンも見る", next: "bread_top" },
            { text: "最初にもどる", next: "start" }
        ]
