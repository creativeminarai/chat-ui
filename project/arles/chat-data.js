...
const chatScenarios = {
    ...
    "croissant_detail": {
        ...
        text: [
            ...
            "バターは[[明治発酵バター]]を使用し、絶妙な[[18層]]に仕上げています。",
            "外は[[サクサク]]、中は[[もっちり]]。ふんわりとした甘みが広がる、まさに自慢の逸品なんですよ！",
            "((（※昨今のバター品薄状態により、日高バターを使用する場合もあります）))"
        ],
        options: [
            { text: "層のこだわりは？", next: "croissant_taste" },
    ...
    "croissant_taste": {
        speaker: "tenshu_bread",
        text: [
            "この断面の層を見てください！[[img:croissant_layer.JPG]]",
            "職人が一つひとつ丁寧に生地を折り重ねることで、この理想的な層が生まれるんです。",
            "この層があるからこそ、あの独特の食感と豊かな香りが生まれるんですよ。"
        ],
        options: [
